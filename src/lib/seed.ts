      ...
      <tr><td align="center">
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;max-width:600px;width:100%;">
          <tr><td style="background:linear-gradient(135deg,#48065a,#ec008c);padding:28px 32px;">
            <span style="font-family:'Avenir ExtraBold','Avenir Next','Avenir',Arial,sans-serif;font-size:24px;font-weight:800;color:#ffffff;">Poss<span style="color:#ffd9e4;">Abilities</span></span>
          </td></tr>
...
export const MODULES: Module[] = [
  ...
  },
  {
    ...
    level: 2,
    kind: "photo",
    title: "Mission 02: Your Photo",
    shortTitle: "Your Photo",
    description:
    ...
    heroPoster: null,
    content: [
      { type: "heading", text: "Smile! 📸" },
      {
        type: "paragraph",
        text: "Take a photo with your camera or upload one. Keep it clear and professional — head and shoulders, plain background, looking at the camera. (A night-out selfie won't make it past HR!)",
      },
    ],
  },
  {
    ...
    level: 3,
    kind: "directors",
    title: "Mission 03: Meet the Directors",
  ...
  },
  {
    ...
    level: 4,
    kind: "manager",
    title: "Mission 04: Meet Your Manager",
  ...
  },
  {
    ...
    level: 5,
    kind: "culture",
    title: "Mission 05: Our Culture & Values",
  ...
  },
  {
    ...
    level: 6,
    kind: "benefits",
    title: "Mission 06: Your Life, Your Perks",
    shortTitle: "Benefits",
    description:
  ...
  },
  {
    ...
    level: 7,
    kind: "bigidea",
    title: "Mission 07: The BIG Idea Portal",
  ...
  },
  {
    ...
    level: 8,
    kind: "pets",
    title: "Mission 08: Very Important Pets",
  ...
  },
  {
    ...
    level: 9,
    kind: "locations",
    title: "Mission 09: Locations & Services",
